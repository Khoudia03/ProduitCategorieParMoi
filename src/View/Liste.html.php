...
<head>
  ...
  <style>
   ...
   ============================================================ */
    ...
    @keyframes pulse-dot {
      0% {
        box-shadow: 0 0 0 0 rgba(20, 216, 160, .55);
      }

      70% {
        box-shadow: 0 0 0 8px rgba(20, 216, 160, 0);
      }

      100% {
        box-shadow: 0 0 0 0 rgba(20, 216, 160, 0);
      }
    }
    ...
    <div>
      <?php for ($i = 1; $i <= $nbrPage; $i++): ?>
        <span class="text-white-500">
          <a href="http://localhost:8000/?page=<?php echo $i ?>"class=""><?php echo $i ?></a>
        </span>
      <?php endfor; ?>
    </div>
  </div>
